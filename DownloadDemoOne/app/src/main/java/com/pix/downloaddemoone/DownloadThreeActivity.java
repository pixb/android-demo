...
import com.pix.downloaddemoone.utils.Downloader;
...
public class DownloadThreeActivity extends ListActivity {
            ...
            if (msg.what == 1) {
                ...
                if (bar != null) {
                    ...
                    if (bar.getProgress() == bar.getMax()) {
                        ...
                        Toast.makeText(DownloadThreeActivity.this, "["+resouceName.getText()+"]下载完成！", Toast.LENGTH_SHORT).show();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_three);
        showListView();
    }
    // 显示listView，这里可以随便添加
    ...
    class DownloadTask extends AsyncTask<String, Integer, LoadInfo> {
        ...
        protected LoadInfo doInBackground(String... params) {
            ...
            if (downloader == null) {
                downloader = new Downloader(urlstr,localfile,threadcount,DownloadThreeActivity.this,mHandler);

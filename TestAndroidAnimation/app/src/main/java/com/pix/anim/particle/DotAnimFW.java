...
public class DotAnimFW extends Dot {
	 ...
	 * 类描述：加载动画，随机加载
	 * 创建人：anan   
	 * 创建时间：2012-12-16 下午6:09:22   
	 * 修改人：anan  
	 * 修改时间：2012-12-16 下午6:09:22   
	 * 修改备注：   
	 * @version        
	 * */
	class loadAnim extends Thread {
		...
		public void run() {
			...
			case 0:
				mFWAnim = new FRAnimation(mContext, new int[] { R.drawable.fw_01,
			...
			case 1:
				mFWAnim = new FRAnimation(mContext,
			...
			case 2:
				mFWAnim = new FRAnimation(mContext, new int[] {

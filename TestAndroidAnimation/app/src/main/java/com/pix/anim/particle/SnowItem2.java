...
public class SnowItem2 extends ParticleItem{
	...
	public SnowItem2(float width, float height,float offsetX,float offsetY) {
	...
	public void move() {
		...
		if (point.x < 0 || point.x > m_fWidth || point.y > m_fHeight) {
			reset();
		}
	}
	...
	private void reset() {
		...
		point.y = rand.nextInt((int)m_fHeight);

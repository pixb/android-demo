 ...
 *
 */
public class JufanBoatView extends GuaGuaAnimView {
	...
	/** 轮船的初始缩放比 */
	private static final float BOAT_MOVE_OUT_SCALE_START = 2f;
	/** 轮船移动缩放比 */
	private static final float BOAT_MOVE_OUT_SCALE_END = 4f;
	...
	private static final int SEA_SCALE_1 = 2;
	private static final int SEA_SCALE_2 = 2;
	private static final int SEA_SCALE_3 = 2;
	...
	private void init() {
		String boatStr = "jufan/live_boat.png";
		String seaStr1 = "jufan/live_sea_1.png";
		String seaStr2 = "jufan/live_sea_2.png";
		String seaStr3 = "jufan/live_sea_3.png";
	...
	private void drawSea1(Canvas canvas) {
		...
		canvas.scale(SEA_SCALE_1, SEA_SCALE_1);
...
//		Log.d(TAG, "drawSea1(),mSea1Alpha:" + mSea1Alpha);
	...
	private void drawSea2(Canvas canvas) {
		...
		canvas.scale(SEA_SCALE_2, SEA_SCALE_2);
	...
	private void drawSea3(Canvas canvas) {
		...
		canvas.scale(SEA_SCALE_3, SEA_SCALE_3);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		mSea2MoveStartX = getWidth() - mSeaBmp2.getWidth() * SEA_SCALE_2 ;
		mSea2MoveStartY = getHeight() * 55 / 100;
		
		mSea3MoveStartX = 0 ;
		mSea3MoveStartY = getHeight() * 40 / 100;
		
		mSea1MoveXDistance = mSeaBmp1.getWidth() * SEA_SCALE_1  - getWidth() ;
		mSea1MoveYDistance = 0 ;
		
		mSea2MoveXDistance = mSeaBmp2.getWidth() * SEA_SCALE_2  - getWidth() ;
		mSea2MoveYDistance = 0 ;
		
		mSea3MoveXDistance = mSeaBmp3.getWidth() * SEA_SCALE_3  - getWidth() ;

...
import com.jingchen.pulltorefresh.activity.PullableRecycleViewActivity;
...
public class MainActivity extends Activity
{
	...
	private void initListView()
	{
		...
		items.add("可下拉刷新上拉加载的RecycleView");
		...
		listView.setOnItemClickListener(new OnItemClickListener()
		{
					...
					int position, long id)
			{
				...
				case 6:
					...
					break;
				case 7:
					it.setClass(MainActivity.this, PullableRecycleViewActivity.class);
					break;
				default:
					break;
				}
